        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between py-4 border-b border-gray-100">
            ...
            <div className="flex-1 lg:flex-none text-center lg:text-left">
              <a href="/" className="inline-block"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight"><span className="text-gray-900">İNEGÖL</span><span className="text-red-600">GÜNDEM</span></h1><p className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-[0.2em]">Bağımsız • Güvenilir • Yerel</p></a>
            </div>
